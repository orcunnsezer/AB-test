...
# H0: M1 = M2 (Sigara İçenler ile İçmeyenlerin Hesap Ortalamaları Arasında fark yoktur)
# H1: M1 != M2 (Sigara İçenler ile İçmeyenlerin Hesap Ortalamaları Arasında fark vardır)
...
############################
#Eğer varyans homojenliği sağlanmıyorsa buraya False gir. welch testini yapmıs oluruz.
...
df = pd.read_csv(r"C:\Users\arcib\OneDrive\Masaüstü\miuul\Measurement Problems\measurement_problems\datasets\diabetes.csv")
df.head()
...
df = pd.read_csv(r"C:\Users\arcib\OneDrive\Masaüstü\miuul\Measurement Problems\measurement_problems\datasets\course_reviews.csv")
df.head()
